              ...
              {foreach $navi as $n => $link}
                  {if $link.parent == 0} 
                      ...
                      {/if}
                          ...
                          {/foreach} 
                          {if $children gt 0}  
                          <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="/{$linktothe}"> {$link.title}  
                        <b class="caret"></b></a>
                          ...
                          {else}
                          <li ><a  href="/{$linktothe}"> {$link.title}   </a>
                          {/if}
                      </li> 
            ...
            <div class="row col-md-5" >
                  <div class="col-sm-6">
                    <div class="input-group">
                      <span class="input-group-btn  {if $masterKey.is.user}
                    active
                  {/if}">
 ...
 -->
  ...
  <script type="text/javascript">
    // set up block configuration
      $('.{$flipBlox} .action').click(function(){ 
        $('.{$flipBlox}').addClass('flip');
      });
      $('.{$flipBlox} .edit-submit').click(function(e){ 
        $('.{$flipBlox}').removeClass('flip');
...
<div id="blox{$flipBlox}CodeDialogs" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="windowTitleLabel" aria-hidden="true" style=" height: 85px; overflow: hidden; position: absolute; top: 35%;   background-color : rgba(0,0,0,0.75);">
